        ...
        <div className="row justify-content-center mt-5">
          <div className="col col-6">
            <div className="row">
              ...
              <Icon.Facebook className='text-secondary fs-5 me-3'/>
              <Icon.Instagram className='text-secondary fs-5 me-3'/>
              <Icon.Twitter className='text-secondary fs-5 me-3'/>
              <Icon.Youtube className='text-secondary fs-5 '/>
              </div>
            </div>
            <div
